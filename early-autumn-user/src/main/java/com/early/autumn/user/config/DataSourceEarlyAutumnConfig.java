package com.early.autumn.user.config;
...
public class DataSourceEarlyAutumnConfig {
    ...
    static final String BASE_PACKAGE = "com.early.autumn.user.dao.earlyautumn";
    ...
    private static final String MYBATIS_MAPPERS = "classpath:com/early/autumn/user/dao/earlyautumn/mapper/*.xml";
